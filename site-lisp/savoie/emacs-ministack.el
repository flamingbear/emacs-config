;;; emacs-ministack.el --- try the new cool stack    -*- lexical-binding: t; -*-
...
(use-package consult
  ...
  ;; Press < then ? in consult-buffer etc. to see available narrowing keys
...
(provide 'emacs-ministack)
;;; emacs-ministack.el ends here
