...
;; $Date: 2002-02-28 18:00:54 $|$Revision: 1.1.1.1 $|~/packages/auto-insert.tar.Z|
...
(defconst auto-insert-version (substring "$Revision: 1.1.1.1 $" 11 -2)
  "$Id: auto-insert-tkld.el,v 1.1.1.1 2002-02-28 18:00:54 savoie Exp $
