...
;;
;; Copyright (C) 1997-2000 Eric M. Ludlam
...
(defconst matlab-mode-version "2.2.4.alpha"
...
(defun matlab-with-emacs-link ()
  ...
  (or (not (featurep 'matlab-eei))
      (not matlab-eei-process)))

...
(defun matlab-frame-init ()
  ...
  (easy-menu-define
   ...
   "Matlab menu"
   '("Matlab"
     ["Start Matlab" matlab-shell (matlab-with-emacs-link) ]
...
(defun matlab-shell-save-and-go ()
  ...
  (let ((fn-name (file-name-sans-extension
	...
	;; Do the equivalent for matlab-eei
	nil
